            ...
            <div className={classes.container}>
              ...
              <GridContainer>
                <GridItem xs={12} sm={6} md={4}>
                  <Card>
                    <img src={javacafeLogo} alt="..." className={classes.imgCardTop} />
                    <CardBody>
                      <h4 className={classes.cardTitle}>자바카페</h4>
                      <p>자바카페는 개발자들 사이의 네트워크를 구축하여 서로 발전하고 친목을 도모하는 오프라인 커뮤니티 입니다. 위 목적을 위해 오프라인 스터디와 오프 라인 세미나 등 여러 가지 행사를 기획, 진행하고 있습니다.</p>
                      <Button 
                        color="success"
                        onClick={() => {
              ...
              <GridContainer>
                <GridItem xs={12} sm={6} md={4}>
                  <Card>
                    <img src="https://chainity.net/wp-content/uploads/2018/07/chainity-logo-V5.png" alt="..." className={classes.imgCardTop} />
                    <CardBody>
                      <h4 className={classes.cardTitle}>준비중</h4>
                      <p>A.I 기반의 추천 시스템으로 선별된 그룹을 추천해 드릴 예정입니다. </p>
                      {/* <p><small className={classes.textMuted}>Last updated 3 mins ago</small></p> */}
                      <Button color="primary" disabled>가입하기</Button>
                    </CardBody>
                  </Card>
                </GridItem>
                <GridItem xs={12} sm={6} md={4}>
